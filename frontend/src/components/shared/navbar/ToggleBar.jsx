      ...
      >
        <nav className="py-4 px-8">
          <div>
            ...
            <p className="flex  gap-2 "><span className="mt-1"><LocationIcon /></span><span><a href=" https://www.google.com/maps/place/Blush+%26+Glow+Beauty+Bar/@43.6961831,-79.2929566,17z/data=!4m14!1m7!3m6!1s0x38d840a6f5aec37:0x1292455a177a54ce!2sBlush+%26+Glow+Beauty+Bar!8m2!3d43.6961831!4d-79.2929566!16s%2Fg%2F11s1sbcm3v!3m5!1s0x38d840a6f5aec37:0x1292455a177a54ce!8m2!3d43.6961831!4d-79.2929566!16s%2Fg%2F11s1sbcm3v?entry=ttu&g_ep=EgoyMDI0MTEwNi4wIKXMDSoASAFQAw%3D%3D">5 Massey Square, East York, ON M4C 5L6, canada.</a></span></p>
            <p className="flex  gap-2 py-6 "><span className="mt-1"><PhoneIcon /></span><a href="cellto">Call: +1 (647)-607-2276</a></p>
            <p className="flex  gap-2 "><span className="mt-1"><EmailIcon /></span><a href="mailto:blushglowbar@gmail.com">blushglowbar@gmail.com</a></p>
